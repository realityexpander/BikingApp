 ...
 */
public abstract class Hilt_TrackingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TrackingFragment_GeneratedInjector) this.generatedComponent()).injectTrackingFragment(UnsafeCasts.<TrackingFragment>unsafeCast(this));
    }
  }
