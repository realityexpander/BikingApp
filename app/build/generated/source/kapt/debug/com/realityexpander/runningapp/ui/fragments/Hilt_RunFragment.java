 ...
 */
public abstract class Hilt_RunFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RunFragment_GeneratedInjector) this.generatedComponent()).injectRunFragment(UnsafeCasts.<RunFragment>unsafeCast(this));
    }
  }
