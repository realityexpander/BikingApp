 ...
 */
public abstract class Hilt_SetupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SetupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SetupFragment_GeneratedInjector) this.generatedComponent()).injectSetupFragment(UnsafeCasts.<SetupFragment>unsafeCast(this));
    }
  }
